...
- **F-005** : Support de **plusieurs fichiers** en parallèle sur une même connexion QUIC (2 fichiers max simultanés).
...
- **F-008** : Barre de progression avec débit, globale et par fichier.
- **F-009** : Bouton Annuler par fichier et global.
- **F-010** : Historique des transferts terminés, persisté localement (200 entrées max).
...
- **F-013** : Thème clair/sombre/auto et couleur de halo personnalisables.
- **F-014** : Miniatures et icônes par type de fichier dans la zone de dépôt.
